...
#
# build_project.tcl: Tcl script for re-creating project 'soc_project'
#
# Generated by Vivado on Wed Apr 29 20:07:23 CEST 2020
...
#
#    "/media/soc/Volume/SoC-project/hardware_design/vivado/soc_project.srcs/sources_1/imports/hdl/zcu102_wrapper.v"
#    "/media/soc/Volume/SoC-project/hardware_design/vivado/src/constraints/misc.xdc"
#    "/media/soc/Volume/SoC-project/hardware_design/vivado/src/constraints/pin_zcu102.xdc"
#    "/media/soc/Volume/SoC-project/hardware_design/vivado/src/constraints/timing.xdc"
#
...
set files [list \
 [file normalize "${origin_dir}/../src/hdl/zcu102_wrapper.v"]\
]
...
proc create_hier_cell_hdmi_output { parentCell nameHier } {
  ...
  create_bd_pin -dir O interrupt1
  create_bd_pin -dir O irq
  create_bd_pin -dir I link_clk
  create_bd_pin -dir O locked
  create_bd_pin -dir I -from 0 -to 0 s_axi_cpu_ar1
  create_bd_pin -dir I s_axis_audio_aclk
  create_bd_pin -dir I s_axis_video_aresetn
  ...
  connect_bd_intf_net -intf_net SB_STATUS_IN_1 [get_bd_intf_pins SB_STATUS_IN] [get_bd_intf_pins v_hdmi_tx_ss_0/SB_STATUS_IN]
  connect_bd_intf_net -intf_net [get_bd_intf_nets SB_STATUS_IN_1] [get_bd_intf_pins SB_STATUS_IN] [get_bd_intf_pins hdmi_hb_tx/status_sb]
  connect_bd_intf_net -intf_net S_AXI_CPU_IN_1 [get_bd_intf_pins S_AXI_CPU_IN] [get_bd_intf_pins v_hdmi_tx_ss_0/S_AXI_CPU_IN]
  connect_bd_intf_net -intf_net s_axi_CTRL1_1 [get_bd_intf_pins s_axi_CTRL1] [get_bd_intf_pins v_mix_0/s_axi_CTRL]
  ...
  connect_bd_net -net Net [get_bd_pins link_clk] [get_bd_pins hdmi_hb_tx/link_clk] [get_bd_pins v_hdmi_tx_ss_0/link_clk]
  connect_bd_net -net Net1 [get_bd_pins s_axis_audio_aclk] [get_bd_pins hdmi_hb_tx/status_sb_aclk] [get_bd_pins v_hdmi_tx_ss_0/s_axi_cpu_aclk] [get_bd_pins v_hdmi_tx_ss_0/s_axis_audio_aclk]
  connect_bd_net -net ap_clk_1 [get_bd_pins ap_clk] [get_bd_pins v_hdmi_tx_ss_0/s_axis_video_aclk] [get_bd_pins v_mix_0/ap_clk]
  ...
  connect_bd_net -net s_axi_cpu_aresetn_1 [get_bd_pins s_axi_cpu_ar1] [get_bd_pins v_hdmi_tx_ss_0/s_axi_cpu_aresetn]
  ...
  set si5324_clk_n_in [ create_bd_port -dir I -type clk si5324_clk_n_in ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000000} \
 ] $si5324_clk_n_in
  set si5324_clk_p_in [ create_bd_port -dir I -type clk si5324_clk_p_in ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000000} \
 ] $si5324_clk_p_in
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_S_AXI_ACLK_FREQ_MHZ {49.995} \
 ] $axi_intc_0
  ...
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {200.01000000000002} \
  ...
  # Create instance: rst_clk_wiz_1_299M, and set properties
  set rst_clk_wiz_1_299M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_wiz_1_299M ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins axi_interconnect_hpm0/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net SB_STATUS_IN_1 [get_bd_intf_pins hdmi_output/SB_STATUS_IN] [get_bd_intf_pins vid_phy_controller_0/vid_phy_status_sb_tx]
  connect_bd_intf_net -intf_net S_AXI_CPU_IN_1 [get_bd_intf_pins axi_interconnect_hpm0/M02_AXI] [get_bd_intf_pins hdmi_output/S_AXI_CPU_IN]
  ...
  connect_bd_intf_net -intf_net hdmi_ctl_iic_IIC [get_bd_intf_ports hdmi_ctl_iic] [get_bd_intf_pins hdmi_ctl_iic/IIC]
  connect_bd_intf_net -intf_net hdmi_output_DDC_OUT [get_bd_intf_ports hdmi_tx_ddc_out] [get_bd_intf_pins hdmi_output/DDC_OUT]
  ...
  connect_bd_intf_net -intf_net hdmi_output_m_axi_mm_video4 [get_bd_intf_pins axi_interconnect_hp0/S03_AXI] [get_bd_intf_pins hdmi_output/m_axi_mm_video4]
  connect_bd_intf_net -intf_net s_axi_CTRL1_1 [get_bd_intf_pins axi_interconnect_hpm1/M08_AXI] [get_bd_intf_pins hdmi_output/s_axi_CTRL1]
  ...
  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins hdmi_output/Din] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o]
  connect_bd_net -net Net [get_bd_pins axi_interconnect_hp0/ACLK] [get_bd_pins axi_interconnect_hp0/M00_ACLK] [get_bd_pins axi_interconnect_hp0/S00_ACLK] [get_bd_pins axi_interconnect_hp0/S01_ACLK] [get_bd_pins axi_interconnect_hp0/S02_ACLK] [get_bd_pins axi_interconnect_hp0/S03_ACLK] [get_bd_pins axi_interconnect_hpm1/ACLK] [get_bd_pins axi_interconnect_hpm1/M00_ACLK] [get_bd_pins axi_interconnect_hpm1/M01_ACLK] [get_bd_pins axi_interconnect_hpm1/M02_ACLK] [get_bd_pins axi_interconnect_hpm1/M03_ACLK] [get_bd_pins axi_interconnect_hpm1/M04_ACLK] [get_bd_pins axi_interconnect_hpm1/M05_ACLK] [get_bd_pins axi_interconnect_hpm1/M06_ACLK] [get_bd_pins axi_interconnect_hpm1/M07_ACLK] [get_bd_pins axi_interconnect_hpm1/M08_ACLK] [get_bd_pins axi_interconnect_hpm1/M09_ACLK] [get_bd_pins axi_interconnect_hpm1/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out4] [get_bd_pins hdmi_output/ap_clk] [get_bd_pins rst_clk_wiz_1_299M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net Net1 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_hpm0/ACLK] [get_bd_pins axi_interconnect_hpm0/M00_ACLK] [get_bd_pins axi_interconnect_hpm0/M01_ACLK] [get_bd_pins axi_interconnect_hpm0/M02_ACLK] [get_bd_pins axi_interconnect_hpm0/M03_ACLK] [get_bd_pins axi_interconnect_hpm0/M04_ACLK] [get_bd_pins axi_interconnect_hpm0/M05_ACLK] [get_bd_pins axi_interconnect_hpm0/M06_ACLK] [get_bd_pins axi_interconnect_hpm0/M07_ACLK] [get_bd_pins axi_interconnect_hpm0/M08_ACLK] [get_bd_pins axi_interconnect_hpm0/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins hdmi_ctl_iic/s_axi_aclk] [get_bd_pins hdmi_output/s_axis_audio_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins vid_phy_controller_0/drpclk] [get_bd_pins vid_phy_controller_0/vid_phy_axi4lite_aclk] [get_bd_pins vid_phy_controller_0/vid_phy_sb_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins interrupts0/In0]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins proc_sys_reset_1/dcm_locked] [get_bd_pins rst_clk_wiz_1_299M/dcm_locked]
  connect_bd_net -net hdmi_ctl_iic_iic2intc_irpt [get_bd_pins hdmi_ctl_iic/iic2intc_irpt] [get_bd_pins platform_interrupts/In2]
  ...
  connect_bd_net -net hdmi_output_interrupt1 [get_bd_pins hdmi_output/interrupt1] [get_bd_pins platform_interrupts/In0]
  connect_bd_net -net hdmi_output_irq [get_bd_pins hdmi_output/irq] [get_bd_pins platform_interrupts/In1]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_interconnect_hp0/ARESETN] [get_bd_pins axi_interconnect_hp0/M00_ARESETN] [get_bd_pins axi_interconnect_hp0/S00_ARESETN] [get_bd_pins axi_interconnect_hp0/S01_ARESETN] [get_bd_pins axi_interconnect_hp0/S02_ARESETN] [get_bd_pins axi_interconnect_hp0/S03_ARESETN] [get_bd_pins axi_interconnect_hpm0/ARESETN] [get_bd_pins axi_interconnect_hpm0/M00_ARESETN] [get_bd_pins axi_interconnect_hpm0/M01_ARESETN] [get_bd_pins axi_interconnect_hpm0/M02_ARESETN] [get_bd_pins axi_interconnect_hpm0/M03_ARESETN] [get_bd_pins axi_interconnect_hpm0/M04_ARESETN] [get_bd_pins axi_interconnect_hpm0/M05_ARESETN] [get_bd_pins axi_interconnect_hpm0/M06_ARESETN] [get_bd_pins axi_interconnect_hpm0/M07_ARESETN] [get_bd_pins axi_interconnect_hpm0/M08_ARESETN] [get_bd_pins axi_interconnect_hpm0/S00_ARESETN] [get_bd_pins axi_interconnect_hpm1/ARESETN] [get_bd_pins axi_interconnect_hpm1/M00_ARESETN] [get_bd_pins axi_interconnect_hpm1/M01_ARESETN] [get_bd_pins axi_interconnect_hpm1/M02_ARESETN] [get_bd_pins axi_interconnect_hpm1/M03_ARESETN] [get_bd_pins axi_interconnect_hpm1/M04_ARESETN] [get_bd_pins axi_interconnect_hpm1/M05_ARESETN] [get_bd_pins axi_interconnect_hpm1/M06_ARESETN] [get_bd_pins axi_interconnect_hpm1/M07_ARESETN] [get_bd_pins axi_interconnect_hpm1/M08_ARESETN] [get_bd_pins axi_interconnect_hpm1/M09_ARESETN] [get_bd_pins axi_interconnect_hpm1/S00_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins rst_clk_wiz_1_299M/ext_reset_in]
  connect_bd_net -net s_axis_video_aresetn_1 [get_bd_ports si5324_rst_out] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins hdmi_ctl_iic/s_axi_aresetn] [get_bd_pins hdmi_output/s_axi_cpu_ar1] [get_bd_pins hdmi_output/s_axis_video_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins vid_phy_controller_0/vid_phy_axi4lite_aresetn] [get_bd_pins vid_phy_controller_0/vid_phy_sb_aresetn]
  connect_bd_net -net si5324_clk_n_in_1 [get_bd_ports si5324_clk_n_in] [get_bd_pins vid_phy_controller_0/mgtrefclk0_pad_n_in]
  connect_bd_net -net si5324_clk_p_in_1 [get_bd_ports si5324_clk_p_in] [get_bd_pins vid_phy_controller_0/mgtrefclk0_pad_p_in]
  ...
  connect_bd_net -net video_clk_1 [get_bd_pins hdmi_output/video_clk] [get_bd_pins vid_phy_controller_0/tx_video_clk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
