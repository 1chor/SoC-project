...
#
# Generated by Vivado on Thu Sep 17 00:51:58 CEST 2020
...
#
#    "/media/soc/Volume/SoC-project/hardware_design/soc_project.srcs/sources_1/imports/hdl/zcu102_wrapper.v"
...
proc cr_bd_zcu102 { parentCell } {
  ...
  user.org:user:simple_filter:1.0\
...
proc create_hier_cell_hdmi_output { parentCell nameHier } {
  ...
  set simple_filter_0 [ create_bd_cell -type ip -vlnv user.org:user:simple_filter:1.0 simple_filter_0 ]
  set_property -dict [ list \
   CONFIG.C_BASEADDR {0x98000000} \
   CONFIG.C_HIGHADDR {0x9800FFFF} \
 ] $simple_filter_0
  ...
  set_property -dict [ list \
   ...
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
   CONFIG.MAX_BURST_LENGTH {1} \
 ] [get_bd_intf_pins /simple_filter_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net zynq_us_ss_0_M05_AXI [get_bd_intf_pins simple_filter_0/S_AXI] [get_bd_intf_pins zynq_us_ss_0/M05_AXI]
  ...
  connect_bd_net -net zynq_us_ss_0_peripheral_aresetn [get_bd_ports SI5324_RST_OUT] [get_bd_pins blake2b_0/S_AXI_ARESETN] [get_bd_pins hdmi_output/peripheral_aresetn_z] [get_bd_pins myled_0/S_AXI_ARESETN] [get_bd_pins simple_filter_0/S_AXI_ARESETN] [get_bd_pins zynq_us_ss_0/peripheral_aresetn]
  connect_bd_net -net zynq_us_ss_0_s_axi_aclk [get_bd_pins blake2b_0/S_AXI_ACLK] [get_bd_pins hdmi_output/s_axi_aclk_z] [get_bd_pins myled_0/S_AXI_ACLK] [get_bd_pins simple_filter_0/S_AXI_ACLK] [get_bd_pins zynq_us_ss_0/s_axi_aclk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x98000000 [get_bd_addr_spaces zynq_us_ss_0/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs simple_filter_0/S_AXI/reg0] SEG_simple_filter_0_reg0
