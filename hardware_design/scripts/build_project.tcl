...
#
# Generated by Vivado on Mon Aug 31 20:42:09 CEST 2020
...
proc create_hier_cell_hdmi_output { parentCell nameHier } {
  ...
  connect_bd_net -net hdmi_output_hdmi_hb [get_bd_ports LED1] [get_bd_pins hdmi_output/hdmi_hb]
  ...
  connect_bd_net -net hdmi_output_locked [get_bd_ports LED0] [get_bd_pins hdmi_output/LED0]
  ...
  connect_bd_net -net zynq_us_ss_0_peripheral_aresetn [get_bd_ports SI5324_RST_OUT] [get_bd_pins hdmi_output/peripheral_aresetn_z] [get_bd_pins zynq_us_ss_0/peripheral_aresetn]
  connect_bd_net -net zynq_us_ss_0_s_axi_aclk [get_bd_pins hdmi_output/s_axi_aclk_z] [get_bd_pins zynq_us_ss_0/s_axi_aclk]
